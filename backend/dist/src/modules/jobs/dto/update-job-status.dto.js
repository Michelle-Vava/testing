...
class UpdateJobStatusDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { status: { required: true, enum: require("../../../shared/enums/job-status.enum").JobStatus } };
    }
}
exports.UpdateJobStatusDto = UpdateJobStatusDto;
__decorate([
    (0, swagger_1.ApiProperty)({ enum: enums_1.JobStatus, description: 'The new status of the job' }),
