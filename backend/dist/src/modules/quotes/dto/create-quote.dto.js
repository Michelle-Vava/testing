...
class CreateQuoteDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { requestId: { required: true, type: () => String, format: "uuid" }, amount: { required: true, type: () => String }, estimatedDuration: { required: true, type: () => String }, description: { required: false, type: () => String }, includesWarranty: { required: false, type: () => Boolean } };
    }
}
