...
describe('JobsService', () => {
  ...
  const mockEmailService = {
    sendJobCompletedEmail: jest.fn(),
    sendJobStatusUpdateEmail: jest.fn(),
    sendReviewReminderEmail: jest.fn(),
  };
  ...
  const mockJob = {
    ...
    provider: { email: 'provider@example.com', name: 'Provider Name' },
    request: { title: 'Test Job Request' },
  };
