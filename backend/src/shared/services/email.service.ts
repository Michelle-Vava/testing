...
import { passwordResetTemplate } from '../../modules/email/templates/password-reset.template';
import { emailVerificationTemplate } from '../../modules/email/templates/email-verification.template';
