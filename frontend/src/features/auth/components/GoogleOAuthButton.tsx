...
export function GoogleOAuthButton() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border-2 border-slate-200 rounded-lg hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 focus:ring-2 focus:ring-slate-500 focus:border-transparent"
    >
