...
export function HeroStateBanner() {
  ...
  // State 1: No vehicles (request-first approach)
  return (
    <div className="bg-gradient-to-r from-slate-700 to-slate-800 dark:from-[#0B1220] dark:to-[#101A2E] rounded-lg p-8 text-white">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            <FileText className="h-6 w-6" />
            <h2 className="text-2xl font-bold text-white">Get your first quote</h2>
          </div>
          <p className="text-slate-300 dark:text-white/65 mb-4">
            Post once. Compare offers from local providers.
          </p>
          <div className="flex gap-3">
            <Button
              onClick={() => navigate({ to: '/owner/requests/new', search: { serviceType: undefined, providerId: undefined } })}
