    ...
    <div className="space-y-4">
      ...
      <Card className="border-yellow-200 bg-yellow-50">
        ...
        <CardContent className="space-y-2 text-sm text-slate-700">
          <div className="flex gap-2">
            ...
            <p>Vehicle saved to your garage</p>
          </div>
          <div className="flex gap-2">
            ...
            <p>You can request quotes instantly</p>
          </div>
          <div className="flex gap-2">
            ...
            <p>Providers see details when quoting</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-slate-600">
          <p>• Get more accurate quotes</p>
          <p>• Faster quote turnaround</p>
          <p>• Providers can suggest preventive maintenance</p>
        </CardContent>
      </Card>
