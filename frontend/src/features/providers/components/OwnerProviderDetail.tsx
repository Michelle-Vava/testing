...
import { useProvidersControllerFindOne } from '@/services/generated/providers/providers';
// Phase 1: Reviews removed - coming in Phase 2
...
export function OwnerProviderDetail() {
  const { providerId } = useParams({ from: '/owner/_layout/providers/$providerId' });

  const { data: provider, isLoading: isLoadingProvider } = useProvidersControllerFindOne(providerId, {
    query: { enabled: !!providerId },
  });

  // Phase 1: Reviews removed
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="shadow-md border border-slate-200">
        <CardContent className="p-6">
          ...
          {/* Phase 1: Reviews section removed - coming in Phase 2 */}
          <div className="text-center py-8">
            <Star className="w-12 h-12 text-gray-300 mx-auto mb-3" />
            <p className="text-gray-500">Reviews coming soon</p>
            <p className="text-sm text-gray-400 mt-1">
              Review system will be available in Phase 2
            </p>
          </div>
        </CardContent>
      </Card>
