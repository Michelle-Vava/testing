...
export function ProviderJobDetail() {
  ...
  const handleCompleteJob = async () => {
     try {
      // Phase 1: Provider marks as pending_confirmation, owner confirms later
      await updateJobStatus({ id: jobId, status: 'pending_confirmation' });
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-3">
          ...
          {job.status === 'pending_confirmation' && (
             <Button variant="outline" disabled className="text-purple-600 border-purple-200 bg-purple-50 opacity-100">
