      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Top-Rated Mechanics Near You</h2>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2">
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-sm text-slate-700">{provider.rating.toFixed(1)} ({provider.reviewCount})</span>
                            </div>
                            {provider.isVerified && (
                              <span 
                                className="text-xs bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full font-medium flex items-center gap-1 cursor-help"
                                title="Verified mechanics have passed background checks, provided proof of insurance and certifications, and maintain a minimum 4.0 rating."
                              >
      ...
      {selectedProvider && (
        <ProviderProfileDrawer
          ...
          provider={{
            ...
            verified: true,
            bio: `Experienced mechanic specializing in ${selectedProvider.specialties?.join(', ') || 'general auto repair'}. Committed to providing quality service with transparent pricing.`,
